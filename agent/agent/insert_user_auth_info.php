...
<div class="content-wrapper" style="border-top: none; padding-left: 10px; width: 698px; padding-bottom: 82px;">
    ...
    if (!$inputs["username"]) {
        ...
        if($countCheckEmptyUser>0){
            ...
            $query = "INSERT INTO customers(name, village, upazilla, district,gender,age,cust_user_id,contact,comment) VALUES('$username', '$password', '$contactNumber', '$email', '$city','$age','$userID','$num','$comment')";
