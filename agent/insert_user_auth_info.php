...
//        echo $num;
        ...
        if($countCheckEmptyUser>0){
            ...
            $query = "INSERT INTO customers(name, village, upazilla, district,gender,age,cust_user_id,contact,comment,code,timeer) VALUES('$username', '$password', '$contactNumber', '$email', '$city','$age','$userID','$num','$comment','$code','$time')";
